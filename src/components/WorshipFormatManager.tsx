...
import { WorshipFormat } from '@/lib/types';
import { doc } from 'firebase/firestore';
import { useTranslation } from '@/context/LocaleProvider';
import { WEEKLY_WORSHIP_FORMAT_ID, resolveServiceSteps } from '@/lib/worship-format';
import { LoadingState } from './LoadingState';
import { WorshipFormatForm } from './WorshipFormatForm';
import { WorshipFormatList } from './WorshipFormatList';
import {
  Dialog,
  DialogContent,
  DialogHeader,
